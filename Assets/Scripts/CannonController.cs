...
public class CannonController : MonoBehaviour
{
    ...
    public void SetTarget(Vector3 target, GameObject owner)
    {
        // Rotamos el pivote del cañon hacia el objetivo.
        var direction = target - cannonPivot.position;
        direction.y = 0;
        ...
        if (CanFire() && CheckVector(target))
        {
            ...
            var projectile = Instantiate(cannonBallPrefab, cannonFirePoint.position, Quaternion.identity);
